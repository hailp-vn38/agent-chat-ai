...
async def verify_device_token(token: str) -> TokenData | None:
    """Verify a device JWT token without database blacklist check.

    Used for device OTA/WebSocket authentication where blacklist check is not needed.
